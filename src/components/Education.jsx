...
const educationData = [
    {
        id: 1,
        degree: "Python Programmer Bootcamp",
        major: "Python Programmer",
        institution: "365 DataScience",
        period: "2024",
        location: "Online Certification",
        gpa: "97/100",
        status: "Graduated",
        description: "Berfokus pada pembelajaran, pelatihan, dan membuat project akhir pada pemrograman python.",
        courses: ["Data Structures", "Algorithms", "Python", "Machine Learning"],
        achievements: [
            "Sertifikat kelulusan bootcamp",
            "Menambah wawasan tentang pemrograman python",
        ],
        icon: "bx-book-open",
        color: "#0d6efd"
    },
    {
        ...
        major: "Pemimpin Ekstrakulikuler T",
        institution: "SMA Negeri 1 Kauman",
        period: "2022 - 2023",
        location: "Tulungagung, Indonesia",
        status: "Graduated",
        description: "Menjadi pemimpin sekaligus pengajar untuk anggota dalam ekstrakulikuler IT.",
        courses: ["Blogspot", "Programming", "Computer Science", "Leadership"],
        achievements: [
    ...
    {
    id: 3,
        degree: "Indonesia GenAI Tour 2024",
        major: "Peserta",
        institution: "AWS UG SURABAYA",
        period: "2024",
        location: "ISTTS Surabaya",
        gpa: "Certified",
        status: "Graduated",
        description: "Workshop  yang mempelajari Prompt Engineering, evaluasi AI model dengan partyrock,  dan membangun aplikasi AI photobooth.",
        courses: ["Prompt", "AI Partyrock"],
        achievements: [
            "AWS Credit $25",
            "Sertifikat",
            "Gratis akses partyrock"
        ],
        icon: "bxl-aws",
        color: "#fd7e14"
    },
    {
        id: 4,
        degree: "ROBOCAMP 2025",
        major: "Programmer, Elektrikal",
        institution: "Fakultas Ilmu Komputer, UPN VETERAN JAWA TIMUR",
        period: "2025",
        location: "UPN VETERAN JAWA TIMUR",
        gpa: "Certified",
        status: "Graduated",
        description: "Berfokus pembelajaran, pelatihan, dan pembuatan project Iot bertema Smart Home sebagai project akhir.",
        courses: ["Mekatronika", "Elektronika", "Pemrograman ARDUINO", "Project Iot"],
        achievements: [
            "Project Iot",
            "Menambah pengalaman di bidang robotic",
            "Menambah wawasan di bidang machine learning"
        ],
        icon: "bx-cloud",
        color: "#fd7e14"
    },
...
const certificationData = [
    ...
    {
        name: "Belajar Dasar Visualiasasi Data",
        issuer: "dicoding",
        year: "2022",
        icon: "bxl-python",
        image: "sertif5.jpg"
    ...
    },
    {
     ...
     {
        name: "Indonesia GenAI Tour 2024",
        issuer: "AWS User Group Surabaya",
        year: "2024",
        icon: "bxl-aws",
        image: "sertif8.jpg"
    },
    {
        name: "Cloud Security: Solution and Best Practices",
        issuer: "AWS User Group Surabaya",
        year: "2024",
        icon: "bxl-aws",
        image: "sertif10.jpg"
            ...
            <div key={index} className="group" data-aos="fade-up">
                ...
                >
                    ...
                    <img
                        src={cert.image}
                        alt={cert.name}
                        className="w-full h-full object-cover rounded-lg mb-4 shadow"
                    />

                    {/* Icon Circle */}
                    <div className={`w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white mx-auto mb-3 shadow-lg transition-all duration-300 ${hoveredCert === index ? 'rotate-360 scale-110' : ''
                        }`}>
                        <i className={`bx ${cert.icon} text-xl`}></i>
                    </div>
