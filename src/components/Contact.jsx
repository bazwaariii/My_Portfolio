...
const contactMethods = [
    {
        ...
        type: "Email",
        details: [
            { name: "Personal Email", value: "arigusnawawa11@gmail.com", icon: "bx-envelope", color: "#0d6efd" },
            { name: "Work Email", value: "23081010250@student.upnjatim.ac.id", icon: "bx-envelope-open", color: "#198754" }
        ],
        icon: "bx-mail-send",
        color: "#0d6efd"
    },
    {
        ...
        type: "Social Media",
        details: [
            { name: "LinkedIn", value: "https://www.linkedin.com/in/muhammad-bazwa-arigusna", icon: "bxl-linkedin", color: "#0A66C2" },
            { name: "Instagram", value: "https://www.instagram.com/inclaucode", icon: "bxl-instagram", color: "#1DA1F2" },
            { name: "GitHub", value: "github.com/bazwaariii", icon: "bxl-github", color: "#181717" }
        ],
        icon: "bx-share-alt",
        color: "#fd7e14"
    },
    {
        ...
        type: "Phone",
        details: [
            { name: "WhatsApp", value: "087701452292", icon: "bxl-whatsapp", color: "#25D366" }
        ],
        icon: "bx-phone-call",
        color: "#6610f2"
    }
