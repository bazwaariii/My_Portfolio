...
const toolsData = [
    {
        ...
        tools: [
            { name: "VS Code", icon: "bx-code-alt", color: "#007ACC" },
             { name: "Jupyter", level: 88, icon: "bx-cylinder", color: "#4479A1" },
            { name: "Google Cloud", level: 82, icon: "bx-cloud", color: "#336791" },
            { name: "Google Colab", level: 75, icon: "bxl-google", color: "#FFCA28" },
    ...
    },
    {
        ...
        tools: [
            ...
            { name: "Photoshop", icon: "bx-image", color: "#31A8FF" }
        ],
        icon: "bx-paint",
        color: "#198754"
    },
