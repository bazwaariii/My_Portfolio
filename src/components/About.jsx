...
const personalInfoData = [
    {
        id: 1,
        category: "Bio",
        details: "Mahasiswa dengan pengalaman 6 tahun dalam bidang Frontend Development, UI/UX Design, dan Machine Learning. Berfokus pada pengembangan aplikasi web yang ramah pengguna, fleksibel, dan mengutamakan pengalaman interaktif.",
        icon: "bx bx-id-card",
        color: "#0d6efd"
    },
    {
        id: 2,
        category: "Hobbies",
        details: "Bermain bola basket, menyelasaikan rintangan game, dan membuat mini project",
        icon: "bx bx-heart",
        color: "#198754"
    },
    {
        id: 3,
        category: "Contact",
        details: "Email: arigusnawawa11@gmail.com\nLinkedIn: linkedin.com/in/muhammad-bazwa-arigusna",
        icon: "bx bx-envelope",
        color: "#6610f2"
    },
    {
        id: 4,
        category: "Location",
        details: "Jl. Medokan Asri Barat, Medokan Ayu, Kec. Rungkut, Surabaya, Jawa Timur",
        icon: "bx bx-map",
        color: "#dc3545"
    },
];
...
const heroData = {
  socialLinks: [
    { id: 1, href: "https://www.linkedin.com/in/muhammad-bazwa-arigusna-96651b28b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app", icon: "bxl-linkedin" },
    { id: 2, href: "https://github.com/bazwaariii", icon: "bxl-github" },
    { id: 3, href: "https://www.instagram.com/inclaucode_?igsh=MWhmcTV3cDJiZmlieQ%3D%3D&utm_source=qr", icon: "bxl-instagram" }
  ],
